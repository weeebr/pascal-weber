 ...
 * 
 * Format:
 * - Single video: { title: "", url: "https://youtu.be/VIDEO_ID" }
 * - Grouped videos: { title: "", urls: ["url1", "url2", "url3"] }
 * 
...
export const mamaVideos = [
  { title: "🇬🇧 John McAfee", url: "https://youtu.be/EQfRO09j_3E?si=4RAxOIFpxPjGM8-D" },
  { title: "🇬🇧  Südamerika: Vergessene Zivilisationen", url: "https://youtu.be/ZvVn05Es7N8?si=_EP0iPq30VAMRLZU" },
  {
    title: "🇩🇪 Geld & Gold",
    urls: [
  ...
  { title: "🇩🇪 Alhambra", url: "https://youtu.be/CQh9BBwbgmM?si=CoI8lIXHFD9Pcf1E" },
  {
    title: "🇩🇪 Magellan",
    urls: [
  ...
  { title: "🇩🇪 Zürich: Schutz vor Überschwemmungen", url: "https://youtu.be/SojUtu3NjN0?si=TSNSm84UmIOmZu5u" },
  { title: "🇬🇧 Die Wikinger: Viel grösserer Einfluss auf Europa als gedacht - kulturell, wirtschaftlich, politisch", url: "https://youtu.be/GcJSF6gKq2g" },
  { title: "🇬🇧 Fiji: Ein Kult übernimmt eine Insel", url: "https://youtu.be/zVgj3dFjWhs?si=-VSWRnAvitOwwTox" },
  { title: "🇬🇧 News: Der Aufstieg der Mainstream-Media", url: "https://youtu.be/AUOQ9Ub632I" },
];
